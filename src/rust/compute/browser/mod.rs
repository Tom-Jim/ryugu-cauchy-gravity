...
const SHADER_OBSERVERS: &str = include_str!("../../../wgsl/viewer/observers.wgsl");
const SHADER_TENSOR_SCALAR: &str = include_str!("../../../wgsl/viewer/tensor_scalar.wgsl");
const SHADER_MASCON_TREE: &str = include_str!("../../../wgsl/viewer/mascon_tree.wgsl");
